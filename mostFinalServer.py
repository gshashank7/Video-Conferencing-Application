...
from multiprocessing import Process as worker, Lock
...
def main():
    ...
    for i in range(0,numberOfUsers):
         ...
         #thread.start_new_thread(listenToClients,(Receive_Sockets_map[keySet[i]] , Sending_Sockets_map[keySet[i]],i),)
